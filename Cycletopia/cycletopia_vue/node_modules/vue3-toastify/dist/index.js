...
var require_function_call = __commonJS({
  "node_modules/core-js/internals/function-call.js"(exports, module2) {
    ...
    module2.exports = NATIVE_BIND ? call5.bind(call5) : function() {
...
var require_engine_user_agent = __commonJS({
  "node_modules/core-js/internals/engine-user-agent.js"(exports, module2) {
    ...
    module2.exports = getBuiltIn4("navigator", "userAgent") || "";
  }
});
...
var require_own_keys = __commonJS({
  "node_modules/core-js/internals/own-keys.js"(exports, module2) {
    ...
    module2.exports = getBuiltIn4("Reflect", "ownKeys") || function ownKeys(it) {
...
var require_collection_delete_all = __commonJS({
  "node_modules/core-js/internals/collection-delete-all.js"(exports, module2) {
    "use strict";
    var call5 = require_function_call();
    var aCallable7 = require_a_callable();
    var anObject13 = require_an_object();
    module2.exports = function deleteAll2() {
...
var require_get_map_iterator = __commonJS({
  "node_modules/core-js/internals/get-map-iterator.js"(exports, module2) {
    var call5 = require_function_call();
    module2.exports = function(it) {
...
var require_same_value_zero = __commonJS({
  "node_modules/core-js/internals/same-value-zero.js"(exports, module2) {
...
__export(src_exports, {
  ...
  toast: () => toast_default,
  toastMap: () => toastMap,
  unmountAllContainer: () => unmountAllContainer,
...
var toastMap = (0, import_vue.reactive)({});
function getAllToast() {
  const rawMap = (0, import_vue.toRaw)(toastMap);
...
function useCssTransition(props3) {
  ...
  const isIn = (0, import_vue2.ref)(false);
  const preventExitTransition = (0, import_vue2.ref)(false);
  const animationStep = (0, import_vue2.ref)(AnimationStep.Enter);
  const options = (0, import_vue2.reactive)(__spreadProps(__spreadValues({}, props3), {
  ...
  const enterClassName = (0, import_vue2.computed)(() => options.appendPosition ? `${options.enter}--${options.position}` : options.enter);
  const exitClassName = (0, import_vue2.computed)(() => options.appendPosition ? `${options.exit}--${options.position}` : options.exit);
  const eventHandlers = (0, import_vue2.computed)(() => props3.pauseOnHover ? {
  ...
  (0, import_vue2.watchEffect)(onExitHandler);
...
// src/store/containerInstances.tsx
var containerInstances = (0, import_vue3.reactive)({});
...
var globalOptions = (0, import_vue4.reactive)({});
...
function mergeOptions() {
  ...
  return (0, import_vue5.mergeProps)(...args);
}
...
var ProgressBar = (0, import_vue7.defineComponent)({
  name: "ProgressBar",
  props: props2,
  setup(props3, _ref) {
    let {
    ...
    const nodeRef = (0, import_vue7.ref)();
    const ariaHidden = (0, import_vue7.computed)(() => props3.hide ? "true" : "false");
    const style = (0, import_vue7.computed)(() => __spreadProps(__spreadValues({}, attrs.style || {}), {
    ...
    const defaultClassName = (0, import_vue7.computed)(() => [`${Default.CSS_NAMESPACE}__progress-bar`, props3.controlledProgress ? `${Default.CSS_NAMESPACE}__progress-bar--controlled` : `${Default.CSS_NAMESPACE}__progress-bar--animated`, `${Default.CSS_NAMESPACE}__progress-bar-theme--${props3.theme}`, `${Default.CSS_NAMESPACE}__progress-bar--${props3.type}`, props3.rtl ? `${Default.CSS_NAMESPACE}__progress-bar--rtl` : null].filter(Boolean).join(" "));
    const classNames = (0, import_vue7.computed)(() => `${defaultClassName.value} ${(attrs == null ? void 0 : attrs.class) || ""}`);
    ...
    const animationendEventHandler = (0, import_vue7.computed)(() => props3.controlledProgress ? null : eventCallback);
    const transitionendEventHandler = (0, import_vue7.computed)(() => !props3.controlledProgress ? null : eventCallback);
...
var CloseButton = (0, import_vue9.defineComponent)({
  name: "CloseButton",
  inheritAttrs: false,
  props: {
    theme: {
  ...
  setup(props3) {
    return () => (0, import_vue8.createVNode)("button", {
    ...
    }, [(0, import_vue8.createVNode)("svg", {
      "aria-hidden": "true",
      "viewBox": "0 0 14 16"
    }, [(0, import_vue8.createVNode)("path", {
      "fill-rule": "evenodd",
...
var Svg = (_ref) => {
  ...
  return (0, import_vue10.createVNode)("svg", (0, import_vue10.mergeProps)({
    "viewBox": "0 0 24 24",
    "width": "100%",
    "height": "100%",
    "fill": theme === "colored" ? "currentColor" : `var(--toastify-icon-color-${type})`
  }, rest), [(0, import_vue10.createVNode)("path", {
    "d": path
  }, null)]);
};
function Warning(props3) {
  return (0, import_vue10.createVNode)(Svg, (0, import_vue10.mergeProps)(props3, {
...
function Spinner() {
  return (0, import_vue10.createVNode)("div", {
...
function getIcon(_ref2) {
  ...
  if (isLoading) {
    ...
    Icon = (0, import_vue11.toRaw)(icon);
  } else if (isFn(icon)) {
    const iconCreator = icon;
    Icon = iconCreator(iconProps);
  } else if ((0, import_vue11.isVNode)(icon)) {
    Icon = (0, import_vue11.cloneVNode)(icon, iconProps);
...
var ToastifyContainer = (0, import_vue15.defineComponent)({
  ...
  setup(_props) {
    ...
    const allToasts = (0, import_vue15.computed)(() => toastMap2[containerId.value] || []);
...
function openToast(content, type) {
  ...
  if (!toastContainerInScreen(options.position)) {
    ...
    const app = (0, import_vue16.createApp)(toastify_container_default, options);
    app.mount(rootDom);
